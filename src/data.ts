...
export const series: Serie[] = [
  ...
  new Serie(
    ...
    "Netflix",
    6,
    "The series begins revolving around Piper Chapman, una mujer en sus treinta, que es sentenciada a 15 meses en Litchfield Penitentiary",
  ...
  new Serie(
    ...
    "BBC",
    4,
    "Sherlock depicts consulting detective Sherlock Holmes (Benedict Cumberbatch) solving various mysteries in modern-day London. Holmes is assisted by his flatmate and friend, Dr John Watson (Martin Freeman)...",
  ...
  new Serie(
    ...
    "BBC",
    2,
    "A Very English Scandal es una miniserie basada en hechos reales...",
